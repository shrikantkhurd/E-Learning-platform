...
$query=mysqli_query($con,"select coursepost.id as pid,coursepost.PostTitle as posttitle, coursepost.PostingDate as postdate, coursecategory.CategoryName as category,coursecategory.id as catid from coursepost left join coursecategory on coursecategory.id=coursepost.CategoryId where coursepost.PostTitle like '%$st%' and coursepost.Is_Active=1 LIMIT $offset, $no_of_records_per_page");
