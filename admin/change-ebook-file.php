...
$query=mysqli_query($con,"update ebookpost set FileName='$file_name' where id='$postid'");
if($query)
{
$msg="Post Feature File updated ";
...
<head>
    ...
    <!-- App title -->
    <title>Tech-World | Edit E-Book File</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <form name="addpost" method="post" enctype="multipart/form-data">
                        <?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select FileName,PostTitle from ebookpost where id='$postid' and Is_Active=1 ");
