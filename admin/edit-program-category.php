...
$query=mysqli_query($con,"Update  programcategory set CategoryName='$category',Description='$description' where id='$catid'");
if($query)
{
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Edit Program Category</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  programcategory where Is_Active=1 and id='$catid'");
$cnt=1;
