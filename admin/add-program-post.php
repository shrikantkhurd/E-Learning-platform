...
move_uploaded_file($_FILES["featureFile"]["tmp_name"],"postProgramFiles/".$file_name);

$status=1;
$query=mysqli_query($con,"insert into programpost(PostTitle,CategoryId,PostDetails,Is_Active,FileName) values('$posttitle','$catid','$postdetails','$status','$file_name')");
...
<head>
    ...
    <!-- App title -->
    <title>Tech-World | Add Program</title>
