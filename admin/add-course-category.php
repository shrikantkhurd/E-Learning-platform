...
$status=1;
$query=mysqli_query($con,"insert into coursecategory(CategoryName,Description,Is_Active) values('$category','$description','$status')");
if($query)
{
...
<head>
    ...
    <title>Tech-World | Add Course Category</title>
