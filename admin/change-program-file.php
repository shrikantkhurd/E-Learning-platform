...
$query=mysqli_query($con,"update programpost set FileName='$file_name' where id='$postid'");
if($query)
{
...
<head>
    ...
    <!-- App title -->
    <title>Tech-World | Edit Program File</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <form name="addpost" method="post" enctype="multipart/form-data">
                        <?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select FileName,PostTitle from programpost where id='$postid' and Is_Active=1 ");
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>New Feature File</b>
                                                        </h4>
                                                        <input type="file" class="form-control" id="featureFile"
                                                            name="featureFile" required>
                                                    </div>
                                                </div>
                                            </div>
