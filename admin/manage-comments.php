                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                <?php 
$query=mysqli_query($con,"Select tblcomments.id,  tblcomments.name,tblcomments.email,tblcomments.postingDate,tblcomments.comment,programpost.id as postid,programpost.PostTitle from  tblcomments join programpost on programpost.id=tblcomments.postId where tblcomments.status=1");
$cnt=1;
...
?></td>
                                                    ...
                                                    <td><a
                                                            href="edit-program-post.php?pid=<?php echo htmlentities($row['postid']);?>"><?php echo htmlentities($row['PostTitle']);?></a>
                                                    </td>
